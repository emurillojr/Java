...
public class Part2 {
	...
	public static void main(String[] args) {
		...
		// grab first letter of the first word of entered sentence and changes it to Uppercase 
		String capFirstLetter = sentence.substring(0,1).toUpperCase();
		
		// put new capLetter with rest of sentence starting from index 1 till end of sentence
		...
		// grabs everything after the first space aka rest of sentence, .trim to remove space at beginning
