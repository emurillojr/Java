...
public class AccessorMutatorExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"The first sales person is : " + firstSalesPerson.FirstName + " " + firstSalesPerson.getLastName());

		SalesPerson secondSalesPerson = new SalesPerson("Mickey", "Mouse");
		System.out.println(
				"The second sales person is : " + secondSalesPerson.FirstName + " " + secondSalesPerson.getLastName());
